...
const Register = () => {
  ...
  // Enforcing strict 8 character minimum
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full rounded-lg border bg-white px-3 py-2.5 pr-10 text-sm text-slate-900 placeholder:text-gray-400 transition-all duration-200 focus:outline-none focus:ring-2 ${
            ...
            {password.length > 0 && !isPasswordValid && (
              <p className="mt-1 text-xs text-red-500">
                Password must be at least 8 characters. You currently have {password.length}.
              </p>
            )}
          </div>
